...
class BotProfile {
  ...
  static const List<String> _maleNames = [
    ...
    'Osman', 'Yusuf', 'Ömer', 'Murat', 'Emre', 'Burak', 'Cem', 'Deniz', 'Efe',
    'Fatih', 'Gökhan', 'Halil', 'Kaan', 'Kerem', 'Koray', 'Onur', 'Serkan',
    'Tolga', 'Uğur', 'Volkan', 'Yasin', 'Yiğit', 'Baran', 'Barış', 'Can',
    'Çağrı', 'Doruk', 'Ege', 'Eren', 'Furkan', 'Görkem', 'Harun', 'Ilgaz',
    'Kağan', 'Levent', 'Mert', 'Oğuz', 'Polat', 'Rüzgar', 'Selim', 'Taner', 'Ufuk',
  ];

  static const List<String> _femaleNames = [
    'Ayşe', 'Fatma', 'Zeynep', 'Elif', 'Esra', 'Merve', 'Gizem', 'Büşra',
    'Seda', 'Derya', 'Gamze', 'Hande', 'İrem', 'Kübra', 'Melis', 'Nazlı',
    'Özge', 'Pelin', 'Selin', 'Tuğba', 'Yağmur', 'Aslı', 'Başak', 'Ceren',
    'Damla', 'Ebru', 'Fulya', 'Gül', 'Hilal', 'Işıl', 'Jale', 'Kardelen',
    'Lale', 'Melek', 'Naz', 'Nur', 'Oya', 'Pınar', 'Reyhan', 'Sevgi',
    'Şule', 'Tuba', 'Ülkü', 'Vildan', 'Yasemin', 'Zara', 'Beren', 'Cansu',
    'Dilan', 'Eylül',
  ];
